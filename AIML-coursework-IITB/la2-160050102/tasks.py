...
def taskSquare(draw):
	...
	nn1 = nn.NeuralNetwork(2, 0.1, 25, 50)
...
def taskMnist():
	...
	nn1 = nn.NeuralNetwork(10, 0.1, 25, 10)
	nn1.addLayer(FullyConnectedLayer(784,20))
	# nn1.addLayer(ConvolutionLayer([3,28,28],[8,8],2,3))
...
def taskCifar10():	
	...
	nn1.addLayer(ConvolutionLayer([3,32,32],[12,12],10,2))
	nn1.addLayer(AvgPoolingLayer([10,11,11],[4,4],2))
	nn1.addLayer(FlattenLayer())
	nn1.addLayer(FullyConnectedLayer(160,10))
	###################################################
